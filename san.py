...
#--model SAN --save SAN_BIX4_G20R10P48 --scale 4 --n_resgroups 20
# --n_resblocks 10 --n_feats 64  --reset --chop --save_results --print_model --patch_size 192
## second-order  Attention Network (SAN)
class SAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        super(SAN, self).__init__()
        n_resgroups = 20  # args.n_resgroups
        n_resblocks = 10 #  args.n_resblocks
